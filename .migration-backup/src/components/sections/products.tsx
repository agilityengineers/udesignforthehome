...
/** "Products & Services" — section header + alternating image/text rows. */
          ...
          return (
            ...
            >
              ...
              <div className="flex max-w-[480px] flex-col gap-4">
                ...
                <h3 className="m-0 font-serif text-[32px] font-medium leading-[1.2] text-balance">
                  {row.title}
                </h3>
                <p className="m-0 text-base leading-[1.7] text-muted text-pretty">
                  {row.body}
                </p>
                <Link
                  href={row.href}
                  scroll={!isAnchor}
                  className="w-fit border-b border-accent pb-[3px] text-[13px] font-semibold uppercase tracking-wide text-accent transition-colors hover:text-ink"
                >
                  {row.linkLabel}
                </Link>
              </div>
