  ...
  ({ className, variant = "onLight", ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={cn(
          "w-full border bg-transparent px-4 py-[14px] text-base outline-none transition-colors placeholder:opacity-70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)] sm:text-sm",
          variant === "onDark"
